...
let questions = [
  { 
    question: "justShout() function ကိုခေါ်လိုက်ရင် ဘာ output ကိုပြမည်နည်း?",
    options: [
      "Shout, Sout", 
      "Shout, it all out!", 
      "Shout, Shout ", 
  ...
  {
    question: "sayTigers() function ကိုခေါ်လိုက်ရင် ဘာ output ကိုပြမည်နည်း?",
    options: [
      "Tigers!", 
      "and Tigers and ", 
  ...
  {
    question:"sayBears() function မှာ ဘာ output ကိုပြမည်နည်း?",
    options: [ 
      " Bears! OH MY! ", 
      "Pandas! OH MY!", 
      " Error will occur", 
  ...
  {
    question: "let shout = Shout; ကို declare လုပ်ခြင်းသည် ဘာလို့အသုံးဝင်သနည်း?",
    options: [ "shout ကို local variable အနေနဲ့ အသုံးပြုနိုင်ဖို့", 
      "shout ကို global scope မှာသုံးနိုင်ဖို့ ",
      "shout ကို function ထဲမှာသာ သုံးဖို့",
      "shout ကို declare လုပ်လို့မရ",],
    answer: "shout ကို global scope မှာသုံးနိုင်ဖို့ ",
  },
