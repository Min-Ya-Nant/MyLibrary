...
let questions = [
  { 
    question: " students.length သည် ဘယ်အဖြေကို return ပြန်မည်နည်း?",
    options: [
      "3", 
      "4", 
      "5", 
  ...
  {
    question: "for-loop တွင် i သည် ဘယ်နေရာမှစပြီး လည်မည်နည်း?",
    options: [
      "1", 
      "0", 
      "2", 
  ...
  {
    question:"students array မှနေ၍ စုစုပေါင်းဘယ်နှစ်ခါ console.log() function ကို ခေါ်မည်နည်း?",
    options: [ 
      "3", 
      "4", 
      "5", 
  ...
  {
    question: "i က loop အပြီးမှာ ဘယ်အတန်ဖိုးကို ပိုင်ဆိုင်မည်နည်း?",
    options: [ 
      "5", 
      "4",
      "6",
