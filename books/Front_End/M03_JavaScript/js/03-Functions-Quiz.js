...
let questions = [
  { 
    question: " checkEquality100, 100 သည် ဘယ် output ကိုပြမည်နည်း?",
    options: [
      "They are equal in type and value", 
  ...
  {
    question: "=== operator ကိုသုံးတဲ့အခါမှာ ဘာအတွက်သုံးပါသလဲ?",
    options: [
      " တန်ဖိုးနဲ့အတူ အမျိုးအစား (type) ကိုလည်း စစ်ဆေးပေးတာပါ ", 
      "တန်ဖိုးကိုသာ စစ်ဆေးတာ", 
      "နေရာပြောင်းပြီးသုံးနိုင်တယ်", 
      "String တွေကိုသာသုံးမယ်"],
    answer: " တန်ဖိုးနဲ့အတူ အမျိုးအစား (type) ကိုလည်း စစ်ဆေးပေးတာပါ ",
  },
  
  {
    question:"== operator ကို သုံးတဲ့အခါ ဘာအတွက် စစ်မည်နည်း?",
    options: [ 
      "တန်ဖိုးနဲ့ အမျိုးအစားကို စစ်မည်", 
      "တန်ဖိုးတူမတူကိုသာ စစ်မည် ", 
      "အမျိုးအစားသာစစ်မည်", 
      " String နှင့် Number များအတွက်သာ",],
    answer: "တန်ဖိုးတူမတူကိုသာ စစ်မည် ",
  },

  {
    question: "checkEquality 100, abc ကိုခေါ်လိုက်ရင် ဘာဖြစ်မည်နည်း?",
    options: [ "They are equal in type and value", 
      "They are equal in value",
      "The values are not equal ",
      "Error will occur",],
    answer: "The values are not equal ",
  },
