...
let questions = [
  { 
    question: " console.log(this); မှာ this ဟာ ဘာကို ရည်ညွှန်းထားတာလဲ?",
    options: [
      "window object ", 
      "child object", 
      "document object", 
  ...
  {
    question: "child.ageTenYears() ကိုခေါ်လိုက်ရင် ဘာ output ထွက်မည်နည်း?",
    options: [
      "10", 
      "20", 
      "Error", 
  ...
  {
    question:"investor.investment.investmentGrowth() မှာ this က ဘာကို ရည်ညွှန်းထားသလဲ?",
    options: [ 
      "window object", 
      "investment object ", 
      "investor object", 
      "Error",],
    answer: "investment object ",
  },

  {
    question: "investor.investment.investmentGrowth() ကိုခေါ်လိုက်ရင် ဘာ output ထွက်မည်နည်း?",
    options: [ "Error", 
      "5000",
      "5750",
      " Undefined",],
