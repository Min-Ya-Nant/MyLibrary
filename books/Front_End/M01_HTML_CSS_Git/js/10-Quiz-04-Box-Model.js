...
let questions = [
  {
    question: "div element ရဲ့ class attribute က ဘာလဲ?",
    options: ["container", "section", "img", "box with number",],
    answer: "container",
  },
 

  {
    question: "HTML document မှာ img element ဘယ်နှစ်ခု ပါဝင်ပါသလဲ?",
    options: [ "1", "2", "3", "4",],
    answer: "4", 
  },

  {
    question: "CSS ဖိုင်ကို ဘယ်လိုသွားဖို့ ချိတ်ဆက်ထားသလဲ? ",
    options: [ "Website", "Broser", "link style.css", "Internet",],
    answer: "link style.css", 
  },
  {
    question: "Hyperlink Types: အမျိုးအစား ဘယ်နှစ်ခုရှိလဲ? ",
    options: [ "1", "2", "3", "4",],
    answer: "3", 
  },
