...
let questions = [
  {
    question: "figure element အတွင်း ဘာတွေပါဝင်သလဲ?",
    options: ["h1", "h2", "p element ပါဝင်ပါတယ်။", "figure element ထဲမှာ img element တစ်ခုနဲ့ figcaption element တစ်ခုပါဝင်ပါတယ်။",],
    answer: "figure element ထဲမှာ img element တစ်ခုနဲ့ figcaption element တစ်ခုပါဝင်ပါတယ်။"
  },
 

  {
    question: "highlighted-text ဆိုတဲ့ class ကို ဘယ်မှာအသုံးပြုထားသလဲ?",
    options: [ "h1 tag", "h2 tag", "h3 tag", "p tag and ul tag",],
    answer: "p tag and ul tag", 
  },

  {
    question: "Hyperlink ကို ဖန်တီးဖို့ ဘယ် tag နဲ့ ရေးရပါသလဲ? ",
    options: [ "h1", "h2", "p tag", "a tag (anchor tag)",],
    answer: "a tag (anchor tag)", 
  },
  {
    question: "href က ဘာကို ခေါ်သလဲ? ",
    options: [ "hyperlink reference ကို ခေါ်ပါတယ်", "hero resource ကို ခေါ်ပါတယ် ", "hyperlink resource ကို ခေါ်ပါတယ်",],
    answer: "hyperlink reference ကို ခေါ်ပါတယ်", 
  },
