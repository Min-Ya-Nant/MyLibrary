...
let questions = [
  { 
    question: "ဒီကုဒ်မှာ head အတွင်း CSS ဖိုင်နှစ်ခုကို ချိတ်ဆက်ထားခြင်း၏ ရည်ရွယ်ချက်က ဘာလဲ?",
    options: [
      "စာမျက်နှာ၏ အပိုင်းအချို့ကို ကွဲပြားသောပုံစံများ ထည့်သွင်းရန်", 
      "ဖိုင်တစ်ခု မရနိုင်ခဲ့လျှင် အခြားဖိုင်ကို အသုံးပြုရန်", 
      "စာမျက်နှာ loading မြန်ဆန်စေရန်", 
      "အခြားစတိုင်ဖန်တီးမှုများ ပံ့ပိုးရန်",],
    answer: "စာမျက်နှာ၏ အပိုင်းအချို့ကို ကွဲပြားသောပုံစံများ ထည့်သွင်းရန်",
  },
  {
    question: "ဒီကုဒ်မှာ navigation လင့်များကို သတ်မှတ်ရန် သုံးထားသော tag သည် ဘာလဲ?",
    options: [
      "nav", 
      "ul", 
      "a", 
  ...
  {
    question: "ဝက်ဘ်စာမျက်နှာ၏ အဓိကအကြောင်းအရာကို ပေးပို့ထားသော article များကို ထည့်သွင်းရန် အသုံးပြုထားသည့် tag သည် ဘာလဲ?",
    options: [ 
      "article", 
      "header",
       "section", 
  ...
  {
    question:"ဒီစာရွက်စာတမ်းအတွင်း <footer> tag ၏ ရည်ရွယ်ချက်က ဘာလဲ?",
    options: [ 
      "ဝက်ဘ်စာမျက်နှာ၏ အကြောင်းအရာအဆုံးကို သတ်မှတ်ရန်", 
      "သတင်းစာမက်ဆေ့ချ် သို့မဟုတ် မူပိုင်ခွင့် သတိပေးချက်များ ပြရန်",
      "Navigation လင့်များကို ထည့်သွင်းရန်",
      "ထပ်ဆင့် အသုံးပြုရန် ရင်းမြစ်များ ထည့်သွင်းရန်",],
    answer: "သတင်းစာမက်ဆေ့ချ် သို့မဟုတ် မူပိုင်ခွင့် သတိပေးချက်များ ပြရန်",
  },
